...
case class Scale(base: Key, scaleType: ScaleType.Value = ScaleType.Major)
    extends MusicSeq {
...
object ScaleType extends Enumeration {
  val Major, Minor, Melodic, Harmonic, PentatonicMinorBlues,
      PentatonicMajorBlues, Ionian, Dorian, Phrygian, Lydian, Mixolydian,
      Aeolian, Locrian, PentatonicMinor, PentatonicMajor = Value
